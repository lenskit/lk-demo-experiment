...
FlexBPR = FlexMFImplicitScorer(embedding_size=50, loss="pairwise")
FlexLMF = FlexMFImplicitScorer(embedding_size=50, loss="logistic")
FlexMF = FlexMFExplicitScorer(embedding_size=50)
